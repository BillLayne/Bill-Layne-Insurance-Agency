...
| **Edit a page** | Text boxes (movable, resizable, re-editable); white-out boxes (**permanent by default** — Settings can turn it off); **highlighter**; **freehand pen**; signatures **and initials** (draw or upload, saved per device); images; quick stamps (date, COPY/VOID/PAID, agency block, custom text + picture stamps, **stamp every page**, **agency-shared stamps**); **crop** (adjustable, confirm before apply); zoom −/Fit/+; Page-jump field + PageUp/PageDown; OCR of the page |
